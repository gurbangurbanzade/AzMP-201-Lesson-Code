...
function createCard(elem, page) {
  ...
  prodCard.addEventListener("click", function (e) {
    ...
    window.location.href = `detail.html?id=${elem.id}&name=qurban`;
  });
  // baskete at
  prodBasket.addEventListener("click", function (e) {
    ...
    // console.log(api.find((elem) => elem.id == e.target.getAttribute("data")));
  ...
  // fava at
  prodFav.addEventListener("click", function (e) {
    e.stopPropagation();
    let elem = api.find((elem) => elem.id == e.target.getAttribute("data"));
